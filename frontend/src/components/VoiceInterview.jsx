...
const VoiceInterview = ({
  ...
  const RECORDING_CHUNK_LIMIT =
    10 * 1024 * 1024;

  const RECORDING_MAX_CHUNK =
    25 * 1024 * 1024;
  ...
  const ensureFullscreen =
    async () => {
      try {
        ...
        console.warn(
          'Could not enter fullscreen automatically:',
          err
        );
          ...
          async () => {
            try {
              ...
              if (
                ...
                throw new Error(
                  'No recording chunks were uploaded.'
                );
              }
              ...
              try {
                ...
                throw new Error(
                  'Recording finalization returned an invalid response.'
                );
              }
  ...
  const stopRecording =
    async () => {
      ...
      if (
        ...
        return recordingUploadRef.current;
      }
  ...
  const handleEndInterview =
    async () => {
      ...
      try {
        ...
        const recordingPath =
          recordingResult?.manifestPath ||
          recordingResult?.interviewFolder ||
          null;
